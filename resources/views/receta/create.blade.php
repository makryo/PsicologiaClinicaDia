                        ...
                        <form method="post" action="{{route('recetas.store')}}">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="medici_one">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="indica_one">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('indica_one')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="medici_two" value="--">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('medici_two')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <label>Indicaciones</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="indica_two" value="--">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('indica_two')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                ...
                                <br>
                                 ...
                                 <label>3.cer medicamento</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="medici_three" step="0.01" value="--">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('medici_three')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <label>Indicaciones</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="indica_three" step="0.01" value="--">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('indica_three')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="medici_four" step="0.01" value="--">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('medici_four')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <label>Indicaciones</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="indica_four" step="0.01" value="--">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('indica_four')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="medici_five" step="0.01" value="--">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('medici_five')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <label>Indicaciones</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="indica_five" step="0.01" value="--">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('indica_five')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
