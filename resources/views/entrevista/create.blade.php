        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- -->
                        <form method="post" action="{{route('entrevistas.store')}}">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="hace_solo">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('hace_solo')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="no_gusta">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('no_gusta')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                ...
                                <br>
                                 ...
                                 <label>¿Qué programas de televisión mira?</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="programas" step="0.01">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('programas')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="felicidad" step="0.01">
                                        <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('felicidad')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="entristece" step="0.01">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('entristece')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="enojo" step="0.01">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('enojo')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="aspec_vida" step="0.01">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('aspec_vida')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="habitos" step="0.01">
                                         <button type="button" class="btn btn-info" data-bs-toggle="popover" title="Informacion" data-bs-content="Escriba respuesta del paciente">?</button>
                                    </div>
                                        @error('habitos')
                                            <small class="text-warning">No se puede dejar en blanco o los datos son erroneos.</small>
